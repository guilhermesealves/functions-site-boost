      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-16">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-orange-300 font-medium">Plataforma de IA para Empresas</span>
          </motion.div>
          ...
          >
            Do plano de negócio à primeira venda. IAs especializadas que te guiam em cada etapa da jornada empreendedora.
          </motion.p>
          ...
          >
            <Button 
              ...
              className="h-14 px-8 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-2xl shadow-xl shadow-orange-500/25 gap-2 text-base"
            >
            ...
            <Button 
              ...
              className="h-14 px-8 bg-white/[0.03] border-white/10 hover:bg-white/[0.06] text-white font-medium rounded-2xl gap-2"
            >
        ...
        >
          <div className="text-center mb-8">
            <h2 className="text-xl font-semibold text-white mb-2">Sua Jornada Empreendedora</h2>
            <p className="text-white/40">Siga o passo a passo ou vá direto ao que você precisa</p>
          </div>
          ...
          <div className="flex items-center justify-center gap-16 md:gap-24">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="text-3xl md:text-4xl font-bold bg-gradient-to-b from-white to-white/40 bg-clip-text text-transparent mb-1">
                  {stat.value}
                </div>
