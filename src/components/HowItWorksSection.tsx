...
const HowItWorksSection = () => {
  ...
  return (
    <section id="como-funciona" className="py-24 relative overflow-hidden bg-background">
      {/* Decorative elements */}
      <div className="absolute top-0 left-1/4 w-72 h-72 rounded-full blur-[120px]" style={{ background: 'radial-gradient(circle, rgba(19, 82, 21, 0.15) 0%, transparent 70%)' }} />
      <div className="absolute bottom-0 right-1/4 w-72 h-72 rounded-full blur-[120px]" style={{ background: 'radial-gradient(circle, rgba(19, 82, 21, 0.1) 0%, transparent 70%)' }} />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mb-4 text-foreground">
            Crie sua empresa em{" "}
            <span className="text-gradient-green">5 etapas</span>
          </h2>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-primary/50 via-primary/30 to-primary/50 hidden md:block" />
          <div className="absolute left-8 top-0 bottom-0 w-px bg-gradient-to-b from-primary/50 via-primary/30 to-primary/50 md:hidden" />
        ...
        >
          <Button 
            ...
            className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg font-semibold rounded-xl shadow-lg glow-green gap-2"
          >
            Começar Agora
